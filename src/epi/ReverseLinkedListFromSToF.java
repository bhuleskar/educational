...
public class ReverseLinkedListFromSToF {
	  ...
	  private static void simpleTest() {
	    ...
	    assert(result.data == 2 && result.next.data == 1
	           && result.next.next.data == 3 && result.next.next.next == null);

	    L = new ListNode<>(1, new ListNode<>(2, new ListNode<>(3, null)));
	    result = reverseSublist(L, 0, 2);
	    assert(result.data == 3 && result.next.data == 2
	           && result.next.next.data == 1 && result.next.next.next == null);
	  }

	  public static void main(String[] args) {
	    simpleTest();
	    ListNode<Integer> L;
	    L = new ListNode<>(11, new ListNode<>(3, new ListNode<>(5, new ListNode<>(7, new ListNode<>(2,null)))));
